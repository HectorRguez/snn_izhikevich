...
# 2 "<built-in>" 2
# 1 "src/snn_izhikevich_top.cpp" 2
...
# 1 "src/snn_config.h" 1



# 1 "src/snn_env.h" 1
# 5 "src/snn_config.h" 2
# 74 "src/snn_config.h"
# 1 "src/snn_defs.h" 1
...
# 1 "src/snn_config.h" 1
# 5 "src/snn_defs.h" 2
# 1 "src/snn_network_defs.h" 1



# 1 "src/snn_config.h" 1
# 5 "src/snn_network_defs.h" 2
# 6 "src/snn_defs.h" 2
# 75 "src/snn_config.h" 2
# 5 "src/snn_types.h" 2
...
# 9 "src/snn_types.h" 2
# 1 "/tools/Xilinx/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 1 3
# 63 "/tools/Xilinx/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 3
...
# 64 "/tools/Xilinx/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 2 3
# 10 "src/snn_types.h" 2
...
# 5 "src/snn_izhikevich_top.cpp" 2

# 1 "src/snn_izhikevich.h" 1
# 15 "src/snn_izhikevich.h"
...
# 7 "src/snn_izhikevich_top.cpp" 2
# 1 "src/snn_izhikevich_axi.h" 1
...
void axis_cp_network_to_mem(
 ...
 VITIS_LOOP_16_1: for (s = 0; s < ((int32_t)((((1 + 1) * 6) + 64 - 1 ) / 64)); s++) VITIS_LOOP_16_2: for (b = 0; b < 64; b++) {
...
void axis_cp_inputs_to_mem(
 ...
 VITIS_LOOP_43_1: for (stream_id = 0; stream_id < ((int32_t)((6 + 32 - 1 ) / 32)); stream_id++) {
  VITIS_LOOP_44_2: for (b = 0; b < 32; b++) {
...
# 8 "src/snn_izhikevich_top.cpp" 2
...
void hls_snn_initialize(hls_stream_64_t& input_stream, uint32_t output_indexes[2]) {
 ...
 VITIS_LOOP_34_1: for (int32_t x = 0; x < 2; x++) {
#pragma HLS UNROLL
 output_indexes_mem[x] = output_indexes[x];
 }


 VITIS_LOOP_40_2: for (int32_t x = 0; x < ((1 + 1) * 6); x++) {
#pragma HLS PIPELINE
 v_mem[x] = -70.0;
  u_mem[x] = -14.0;
 }
...
__attribute__((sdx_kernel("hls_snn_izikevich", 0))) uint1_t hls_snn_izikevich(
  ...
  hls_stream_64_t& input_stream3,
  hls_stream_64_t& output_stream) {
#line 29 "/home/hector/Desktop/TFM/automate_snn_hls/snn_izhikevich/vitis_hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=hls_snn_izikevich
# 72 "src/snn_izhikevich_top.cpp"
